<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Patients.aspx.cs" Inherits="SafeTravel.Admin.Patients" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">

                <div id="PatientsListTitle" runat="server" class="ContentHead"><h1>Lista de Utentes
                 <asp:Button ID="AddPatient" runat="server" OnClick="AddPatient_Click" Text="Novo Utente" class="btn btn-primary" 
                    style="margin-left:950px; width:180px; "/>
                </h1>
            </div>
     <asp:GridView ID="PatientsList" runat="server" AutoGenerateColumns="False" ShowFooter="True" GridLines="Vertical" CellPadding="4"
        ...
        <asp:HyperLinkField DataNavigateUrlFields="patient_id" DataTextField="p_name" HeaderText="Nome" DataNavigateUrlFormatString="AddPatient.aspx?patientID={0}" /> 
