<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MedicEditAndGoto.aspx.cs" Inherits="SafeTravel.Medic.MedicEditAndGoto" %>
...
<style type="text/css">
    ...
    <table >
        <tr>
            ...
            <td>
                ...
                <asp:RegularExpressionValidator ID="RegularExpressionValidatorPatientName" runat="server" Text="* Nome inválido." ControlToValidate="PatientName" SetFocusOnError="True" Display="Dynamic" ValidationExpression="^[a-zA-ZáâãÁÃÂéêÉÊíîÍÎóôõÓÕÔúûÚÛ\s]{1,20}$" ForeColor="Red"></asp:RegularExpressionValidator>
            </td>
        </tr>
                       <tr>
            ...
            <td>
                ...
                <asp:RegularExpressionValidator ID="RegularExpressionValidatorPatientAdress" runat="server" Text="* Morada inválida." ControlToValidate="PatientAddress" SetFocusOnError="True" Display="Dynamic" ValidationExpression="^[a-zA-Z0-9áâãÁÃÂéêÉÊíîÍÎóôõÓÕÔúûÚÛ\s]{1,20}$" ForeColor="Red"></asp:RegularExpressionValidator>
            </td>
        </tr>
             <tr>
   ...
   <p> </p> 
       ...
       <asp:Button ID="Save" runat="server" OnClick="Save_Click" Text="Seguinte" Width="150px" class="btn btn-primary" CausesValidation="true"
